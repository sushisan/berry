...
En muchos casos, los valores no booleanos también se pueden usar como tipos booleanos.
...
Una función es un objeto de solo lectura y no se puede modificar una vez definida.
